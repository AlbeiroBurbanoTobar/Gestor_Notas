...
from .views import home, home_admin, home_estudiante, registrar_estudiante, registrar_profesor, eliminar_usuario, lista_usuarios, crear_asignatura, crear_grupo, asignar_estudiantes_a_grupo
